...
const STEPS: Step[] = [
    {
        ...
        description:
            "Link your Meta Business Manager in minutes. 100% official WhatsApp Cloud API — zero technical knowledge needed.",
        icon: Link,
    },
    {
        id: 2,
        title: "Train the AI",
        description:
            "Upload your product catalog, website URL, or business knowledge. Our AI learns your business deeply in seconds.",
        icon: Brain,
    },
    {
        id: 3,
        title: "Deploy Agent",
        description:
            "Your AI agent is now live on WhatsApp. It starts greeting customers, qualifying leads, and answering FAQs immediately.",
        icon: Send,
    },
    {
        id: 4,
        ...
        description:
            "From booking appointments to processing orders, everything happens automatically in the chat.",
        icon: Zap,
    },
    {
        id: 5,
        ...
        description:
            "Monitor performance through your dashboard. Reach thousands of customers without adding a single staff member.",
        icon: TrendingUp,
    },
];
...
const AnimationCanvas = ({
    ...
    return (
        <div className="relative w-full h-[100vh] flex items-center justify-center pointer-events-none">
            ...
            <motion.div
                style={{ y: p1Y, scale: p1Scale, x: -220 }}
                className="absolute glass-card p-6 rounded-[32px] w-52 text-center shadow-md"
            >
                <ShoppingBag
                    className="mx-auto mb-4 text-blue-500 drop-shadow-[0_0_15px_rgba(96,165,250,0.5)]"
                    size={48}
                />
            ...
            <motion.div
                style={{ y: p2Y, scale: p2Scale, x: 0 }}
                className="absolute glass-card p-6 rounded-[32px] w-52 text-center shadow-md"
            >
                <Globe
                    className="mx-auto mb-4 text-purple-500 drop-shadow-[0_0_15px_rgba(168,85,247,0.5)]"
                    size={48}
                />
                <p className="text-slate-800 font-bold text-lg">
                    www.website.com
            ...
            <motion.div
                style={{ y: p3Y, scale: p3Scale, x: 220 }}
                className="absolute glass-card p-6 rounded-[32px] w-52 text-center shadow-md"
            >
                <Briefcase
                    className="mx-auto mb-4 text-amber-500 drop-shadow-[0_0_15px_rgba(251,191,36,0.5)]"
                    size={48}
                />
                <p className="text-slate-800 font-bold text-lg">
                    Business Details
            ...
            <motion.div
                style={{ y: machineY, opacity: machineOpacity, x: -250 }}
                className="absolute w-64 h-64 glass-card rounded-[48px] border-t-8 border-l-8 border-blue-500 flex flex-col items-center justify-center shadow-lg z-10 bg-white/80"
            >
                <Package
                ...
                <div className="w-24 h-3 bg-slate-200 rounded-full mt-6 overflow-hidden">
                    <motion.div
                        ...
                        className="w-8 h-full bg-blue-500 rounded-full shadow-[0_0_5px_#60a5fa]"
                    />
                </div>
            </motion.div>
            ...
            <motion.div
                style={{ y: machineY, opacity: machineOpacity, x: 250 }}
                className="absolute w-64 h-64 glass-card rounded-[48px] border-t-8 border-r-8 border-amber-500 flex flex-col items-center justify-center shadow-lg z-10 bg-white/80"
            >
                <Calendar
                    className="text-amber-500 mb-6 animate-[spin_4s_linear_infinite]"
                    size={64}
                />
                <p className="text-sm font-black uppercase tracking-widest text-slate-600">
                    Booking Engine
                ...
                <div className="w-24 h-3 bg-slate-200 rounded-full mt-6 overflow-hidden">
                    <motion.div
                        ...
                        className="w-8 h-full bg-amber-500 rounded-full shadow-[0_0_5px_#fbbf24]"
                    />
                </div>
            </motion.div>

            <motion.div
                style={{ x: chat1X, y: chat1Y, opacity: chat1Op }}
                className="absolute w-14 h-14 rounded-full bg-white flex items-center justify-center shadow-lg border border-slate-200 z-50"
            >
                <MessageCircle className="text-black" size={28} />
            </motion.div>
            <motion.div
                style={{ x: chat2X, y: chat2Y, opacity: chat2Op }}
                className="absolute w-14 h-14 rounded-full bg-white flex items-center justify-center shadow-lg border border-slate-200 z-50"
            >
                <MessageCircle className="text-black" size={28} />
            </motion.div>
            ...
            <svg
                ...
                className="absolute w-[1000px] h-[1000px] pointer-events-none z-10"
            >
                <motion.path
            ...
            >
                ...
                <div className="grid grid-cols-3 gap-8 mb-8">
                    <div className="h-40 bg-slate-50 rounded-3xl border border-slate-200 flex flex-col justify-end p-6 shadow-sm">
                        <div className="text-5xl font-black text-whatsapp-green mb-3 drop-shadow-sm">
                            1,248
                        </div>
                    ...
                    <div className="h-40 bg-slate-50 rounded-3xl border border-slate-200 flex flex-col justify-end p-6 shadow-sm">
                        <div className="text-5xl font-black text-blue-500 mb-3 drop-shadow-sm">
                            342
                        </div>
                        <div className="text-sm font-bold text-slate-600 uppercase tracking-widest">
                            Orders Handled
                    ...
                    <div className="h-40 bg-slate-50 rounded-3xl border border-slate-200 flex flex-col justify-end p-6 shadow-sm">
                        <div className="text-5xl font-black text-amber-500 mb-3 drop-shadow-sm">
                            156
                        </div>
                        <div className="text-sm font-bold text-slate-600 uppercase tracking-widest">
                            Bookings Fixed
                ...
                <div className="h-40 bg-gradient-to-t from-whatsapp-green/20 via-whatsapp-green/5 to-transparent rounded-3xl border border-whatsapp-green/30 relative overflow-hidden shadow-[inset_0_-20px_50px_rgba(37,211,102,0.1)]">
                    ...
                    <svg
                        className="absolute inset-0 w-full h-full drop-shadow-[0_0_10px_rgba(37,211,102,0.6)]"
                        preserveAspectRatio="none"
                    >
                        <path
                            d="M 0 160 Q 150 140 300 100 T 500 120 T 700 40 L 900 20"
                            fill="none"
                            stroke="#25D366"
                            strokeWidth="6"
                            strokeLinecap="round"
            ...
            >
                <motion.div
                    animate={
                        isLooping
                            ? { y: [-40, 40], x: [-20, 20], rotate: [-8, 8] }
                            : { y: [-10, 10], x: 0, rotate: 0 }
                    }
                    transition={{
                        repeat: Infinity,
                        duration: isLooping ? 2.5 : 5,
                        repeatType: "mirror",
                        ease: "easeInOut",
                    }}
                    ...
                    >
                        <motion.div
                            ...
                            className={cn(
                                ...
                                isRedFlames
                                    ? "bg-gradient-to-b from-yellow-300 via-orange-500 to-red-600 shadow-[0_40px_80px_rgba(239,68,68,0.9)]"
                                    : "bg-gradient-to-b from-cyan-300 via-blue-600 to-transparent shadow-[0_20px_40px_rgba(59,130,246,0.5)]",
                            )}
                        />
                    </motion.div>
                </motion.div>
    ...
    return (
        <section id="how-it-works" className="relative w-full text-slate-800">
            ...
            <div className="pt-32 pb-16 text-center max-w-4xl mx-auto px-6 relative z-10">
                ...
                >
                    <span className="text-sm font-black uppercase tracking-widest text-whatsapp-green">
                ...
                >
                    Deploy Magic <br />
                    <span className="text-whatsapp-green italic drop-shadow-sm">
                        in Minutes
                    </span>
                </motion.h2>
            </div>
            ...
            <div ref={trackRef} className="relative w-full h-[500vh]">
                ...
                <div className="absolute top-0 left-0 w-full h-full pointer-events-none flex flex-col">
                    {STEPS.map((step, index) => (
                        <div
                            key={step.id}
                            className="h-[100vh] w-full flex items-center justify-start px-6 lg:px-[10%]"
                        >
                            <motion.div
                                ...
                                className={cn(
                                    ...
                                    activeStep === index
                                        ? "border-whatsapp-green scale-100 opacity-100 shadow-[0_20px_50px_rgba(37,211,102,0.05)]"
                                        : "border-slate-200 scale-90 opacity-40 shadow-none",
                                )}
                            >
                                <div
                                    className={cn(
                                        ...
                                        activeStep === index
                                            ? "bg-whatsapp-green/20 border-whatsapp-green text-whatsapp-green"
